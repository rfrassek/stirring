...
where
\begin{equation}
\Omega_{x}:=\left\{(n_{1}^{x},\ldots,n_{N}^{x})\in\mathbb{N}_0^{N}\;:\; \sum_{k=1}^{N}n_{k}^{x}=\twoj\right\}
\end{equation}
...
\begin{align*}
	 &\langle n^{x}|d_{x}\otimes \dd|\xi^{x}\rangle\\&=\langle n_{1}^{x},\ldots,n_{N}^{x}| (\exp{(E_{12}^{x}+\ldots+E_{1N}^{x}}))^{T}R_{x}\otimes\sum_{q_{2}^{\widehat{x}},\ldots,q_{N}^{\widehat{x}}=0}^{\infty}\prod_{k=2}^{N}\left(\rho_{k}^{x}\right)^{q_{k}^{\widehat{x}}}\langle q_{2}^{\widehat{x}},\ldots,q_{N}^{\widehat{x}}|
...
\begin{align*}
\sum_{q_{2}^{\widehat{x}},\ldots,q_{N}^{\widehat{x}}=0}^{\infty}\prod_{k=2}^{N}\left(\rho_{k}^{x}\right)^{q_{k}^{\widehat{x}}}\langle q_{2}^{\widehat{x}},\ldots,q_{N}^{\widehat{x}}|m_{2}^{\widehat{x}},\ldots,m_{N}^{\widehat{x}}\rangle=\prod_{k=2}^{N}\left(\rho_{k}^{x}\right)^{m_{k}^{\widehat{x}}}
\end{align*}
...
\begin{equation}\label{siteHadamardII}
    \begin{split}
&H_{x}^{T}d_{x}\otimes\sum_{m_{2}^{\widehat{x}},\ldots,m_{N}^{\widehat{x}}=0}^{\infty}\prod_{k=2}^{N}\left(\rho_{k}^{x}\right)^{m_{k}^{\widehat{x}}}\langle m_{2}^{\widehat{x}},\ldots,m_{N}^{\widehat{x}}|
\\=&
...
\\&=
d_{x}\otimes \sum_{m_{2}^{\widehat{x}},\ldots,m_{N}^{\widehat{x}}=0}^{\infty}\prod_{k=2}^{N}\left(\rho_{k}^{x}\right)^{m_{k}^{\widehat{x}}}\langle m_{2}^{\widehat{x}},\ldots,m_{N}^{\widehat{x}}|\widetilde{H}_{x}
\\&=
