...
\end{align*}
where {\color{red} we used the orthogonality relation \eqref{ortho}}. 
...
\end{align*}
where we used the definitions of the action of $E_{ab}$ {\color{red} and the orthogonality relations \eqref{ortho}}, together with the fact that $\xi_{N}^{x}=\nu-\sum_{a=1}^{N-1}\xi_{a}^{x}$. 
