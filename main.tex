...
\begin{equation}\label{DualityRelation}
    H^{T}D=D\widetilde{H}
\end{equation}
\subsection{Duality for the multi-species stirring process}
...
To prove the duality relation between \eqref{OriginalHamiltonian} and \eqref{DualHamiltonian} with the duality matrix \eqref{duality-function-good} we shall show that 
\begin{equation}
    H^{T}D=D\widetilde{H}
\end{equation}
...
\end{equation}
We will prove these two statements separately in the following. 
