...
{\color{blue} \paragraph{Example for an $L=2$ chain.} To clarify equation \eqref{implicit-mass-function} we report the example of a chain with $L=2$, where we compute the probability mass functions of three configurations. Without loss of generality we assume that the particles are always of species $1$. We have that 
 \begin{itemize}
 	...
 	\begin{align}
 		\mu(1,N)=&\mathbb{E}\left[\mathbbm{1}_{\{Y_{1}=1\}}\mathbbm{1}_{\{Y_{2}=1\}}\right]=\mathbb{E}\left[\mathbbm{1}_{\{Y_{1}=1\}}\left(1-\sum_{a=1}^{N-1}\mathbbm{1}_{\{Y_{2}=a\}}\right)\right]\nonumber
 		\\=&
 	...
 	\begin{align}
 		\mu(N,N)=&\mathbb{E}\left[\mathbbm{1}_{\{Y_{1}=1\}}\mathbbm{1}_{\{Y_{2}=1\}}\right]=\mathbb{E}\left[\left(1-\sum_{a_{1}=1}^{N-1}\mathbbm{1}_{\{Y_{1}=_{1}a\}}\right)\left(1-\sum_{a_{2}=1}^{N-1}\mathbbm{1}_{\{Y_{2}=a_{2}\}}\right)\right]\nonumber
 		\\=&
