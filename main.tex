...
boundary-driven version of the partial symmetric exclusion process \cite{ss,carinci2013duality}.
...
\com{double check}
   ...
   {\color{red}
\begin{equation}
[E,E_{k\ell}]=\sum_{a=2}^{N}\left(E_{ak}\delta_{\ell 1}-E_{\ell 1}\delta_{ak}\right)=-E_{\ell 1};
\end{equation}
}
\begin{equation}
