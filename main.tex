...
&=\left[\prod_{x=1}^{L}\lambda_{\tau_{x}}^{\delta_{\tau_x<N}}\right] \frac{\Gamma\left(2 \right)}{\Gamma\left(2+L\right)}\prod_{x=1}^{L} \frac{\Gamma\left(2+\sum_{j=x}^{L}\delta_{\tau_{x},N}\right)}{\Gamma\left(1+\sum_{j=x}^{L}\delta_{\tau_{x},N}\right)}\\
&=\left[\prod_{x=1}^{L}\lambda_{\tau_{x}}^{\delta_{\tau_x<N}}\right] \frac{\Gamma\left(2 \right)}{\Gamma\left(1+L\right)}\prod_{x=1}^{L} \left(2+\sum_{j=x}^{L}\delta_{\tau_{x},N}\right)\\
