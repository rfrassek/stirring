...
\subsection{Reaction-diffusion process with coupled discrete Laplacians}
...
\begin{equation}
    H_{x,y}^{c}=\sum_{a,b=0}^{N}\left(E_{g_{i}(l)a}^{c}\otimes E_{g_{i}(k)l}^{y}-E_{aa}^{x}\otimes E_{ll}^{y}\right)
\end{equation}
and 
\begin{equation}
