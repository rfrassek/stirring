...
\end{equation}
To prove this statement we introduce the following notation. We identify each state by 
\begin{equation}
...
\end{equation}
\begin{equation}
	D_{i,j}^{2L}|\tau_{1},\ldots,\tau_{L}\rangle=-2|\tau_{1}^{'}\ldots,\tau_{L}^{'}\rangle \qquad \text{where}\qquad \tau^{'}_{x}=\begin{cases}
		\tau_{x}\quad &\text{if}\quad \tau_{x}\neq i\\
		j\quad &\text{if}\quad \tau_{x}=i
	\end{cases}
\end{equation}
...
\end{align}
\begin{equation}
	D_{k,j}^{2L}B_{i}^{L}|\Psi_{0}^{0}\rangle=0\qquad \forall k,j,i\in\{1,\ldots,N-1\}\;:\;k\neq i
\end{equation}
\begin{equation}
	D_{i,i}^{2L}\Psi_{0}^{0}\rangle=-|\Psi_{0}^{0}\rangle \qquad \forall i\in \{1,\ldots,N-1\}
\end{equation}
Indeed,
\begin{align}
D_{i,i}^{2L}|\Psi_{0}^{0}\rangle=	(2e_{ii}^{tot}-I)|\Psi_{0}^{0}\rangle=-|\Psi_{0}^{0}\rangle
\end{align}
\begin{equation}\label{GainCommutationQ}
	Q_{0}^{2L}|\Psi_{0}^{0}\rangle=(2L+N)(1+L)|\Psi_{0}^{0}\rangle
\end{equation}
Therefore, $Q_{0}^{2L}$ acts diagonally on the state $|\Psi_{0}^{0}\rangle$. Indeed,
\begin{align}
...
since 
\begin{equation}
\sum_{j,k=1}^{N-1}e_{kj}^{tot}e_{jk}^{tot}|\Psi_{0}^{0}\rangle=0\qquad e_{NN}^{tot}|\Psi_{0}^{0}\rangle=L|\Psi_{0}^{0}\rangle
\end{equation}
Using \eqref{BActionVoid} and \eqref{GainCommutationQ} we have that for all $i,j,k\in\{1,\ldots,N-1\}$
\begin{equation}\label{Three-Relation}
	Q_{0}^{2L}B_{k}^{2L-1}Q_{0}^{2L}B_{j}^{2L-1}Q_{0}^{2L}B_{i}^{2L-1}|\Psi_{0}^{0}\rangle=B_{i}^{2L-1}B_{j}^{2L-1}B_{k}^{2L-1}\prod_{j=}^{3}\left(Q_{0}^{2L}-2j(D_{11}^{2L}+D_{NN}^{2L})+4j(j-1)\right)|\Psi_{0}^{0}\rangle
\end{equation}
Observe that \eqref{Three-Relation} also implies that 
\begin{equation}
	Q_{0}^{2L}B_{i}^{2L-1}Q_{0}^{2L}B_{j}^{2L-1}|\Psi_{0}^{0}\rangle=Q_{0}^{2L}B_{i}^{2L-1}Q_{0}^{2L}B_{i}^{2L-1}|\Psi_{0}^{0}\rangle
\end{equation}
i.e. $Q_{0}^{2L}B_{i}^{2L-1}$ and $Q_{0}^{2L}B_{j}^{2L-1}$ do commute. This simplify formula \eqref{W-charges-Bad} as
\begin{equation}
	\begin{split}
...
\end{split}
\end{equation}
Therefore, we can generalize \eqref{Three-Relation} and find 
\begin{equation}
	\begin{split}
		W|\Psi_{0}^{0}\rangle =&\sum_{k_{1}=0}^{L}\ldots\sum_{k_{N-1}}^{L}\mathbbm{1}_{\{k_{1}+\ldots+k_{N-1}\leq L\}}2^{k_{1}+\ldots+k_{N-1}}\Delta_{1}^{k_{1}}\cdots \Delta_{N-1}^{k_{N-1}}\binom{k_{1}+\ldots+k_{N-1}}{k_{1},\ldots,k_{N-1}}\\&
		\left(B_{1}^{2L-1}\right)^{k_{1}}\cdots\left( B_{N-1}^{2L-1}\right)^{k_{N-1}}\prod_{j=1}^{k_{1}+\ldots k_{N-1}}\left\{(\Lambda_{0}+\epsilon)-Q_{0}^{2L}+2j(D_{1,1}^{2L}+D_{N,N}^{2L})-4j(j-1)\right\}^{-1}|\Psi_{0}^{0}\rangle
	\end{split}
\end{equation}
where 
\begin{equation}
