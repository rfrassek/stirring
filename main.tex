...
\textbf{Remark}: observe that, up to a specific choice of the $\alpha$'s, the left boundary generator $\mathcal{L}_{\text{left}}^{rd}$ has the form of the one of the multi-species stirring process \eqref{siteGenerator}. 
