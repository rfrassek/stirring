...
In this context, the integrable structure of the process can be combined with duality. As shown in \cite{frassek2020eigenstates,frassek2020duality}, this approach leads to closed-form expressions for the correlations and the non-equilibrium steady state. 
