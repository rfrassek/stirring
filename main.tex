...
\begin{flushright}
	$\square$
\end{flushright}
\begin{remark}[Interpretation the elements $\Psi^{'}(\bm{\tau})$]
	For any given $\bm{\tau}\in \Omega^{'}$ we have that 
	...
	\end{equation} 
Indeed, arguing as in the previous proof, we have that
\begin{align}
...
\end{cases}
\end{equation} Now we consider the elements $\langle\bm{\sigma}|D|\xi(\bm{\tau})\rangle$ of the duality matrix $D$. Therefore, we have
\begin{align}
...
\begin{equation}
	...
	\end{cases}
\end{equation}
 Therefore, equation \eqref{interpretation-PsiP} follows. 
\end{remark}
