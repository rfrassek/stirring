...
\end{equation}
On the occupation variable $n_{a}^{L}$ the action is similar, but with the upper case $1$ replaced by $L$.\\ In the spirit of \cite{casini2022uphill} we define the average density occupation of species $a$ at site $x$ as
\begin{equation}
