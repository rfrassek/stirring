...
{\color{red}Explain the model here.... $N$-species }
...
process and provide its Lie algebraic description in terms of $gl(N)$ generators. In Section~\ref{sectionDuality} we prove an absorption duality (Theorem~\ref{thm-duality})
and show that the problem of characterizing the non-equilibrium
steady state can be reduced to the computation of the absorption probabilities similar to the single species case [SPOHN?]. The duality is proved for a
system whose spatial structure is described by a general graph. In Section~\ref{sectionIntegrabiliy} we then obtain a closed formula
